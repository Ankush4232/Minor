...
<?php
  ...
  <div class="main-container">
    <div class="form-container">
      ...
      <form id="deliveryForm" method="post" action="submitOrder1.php?uid=<?php echo $encrypted_uid; ?>">
        ...
        <div>
          ...
          <input type="hidden" name="total_amount" value="<?php echo $row["sell_price"]+10; ?>"> 
...
//   while ($row = $result->fetch_assoc()) {
    ...
    User ID: <?php echo $uid ?>,        Total Product : <?php echo $result->num_rows ?>,   
        Total price of Product : <?php echo $row["sell_price"]; ?>
</textarea>
    ...
    <div class="price-box">
      <h4>PRICE DETAILS</h4>
      <div class="price-line"><span>Price (<?php echo $count-1 ?> item)</span><span>₹<?php echo $row["sell_price"]; ?></span></div>
      ...
      <hr>
      <div class="price-line total"><span>Total Payable</span><span>₹<?php echo $row["sell_price"]+10; ?></span></div>
    </div>
    <?php
            } else {
              echo "0 results";
